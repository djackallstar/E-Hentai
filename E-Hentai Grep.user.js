    ...
    var grep_patterns = [ // Add [[pattern_1, pattern_2, ... , pattern_n], 'color'] to the array by yourself.
        [ // Items
            [
                ...
                /\bphazon\b/i,
                // Bindings
                /binding.*(balance|focus|protection|warding|fleet|negation|heimdall|cheetah|fox|owl|heaven-sent)/i,
                /^\s*(balance|focus|protection|warding|fleet|negation|heimdall|cheetah|fox|owl|heaven-sent)/i,
                // Graded materials
                /(low|mid|high).*grade.*cloth/i,
                /(lg|mg|hg).?cloth/i,
                /scrap.*(cloth|wood)/i,
                // ED
                /\b(energy|drink)\b/i,
        ...
        [ // Holy Gear
            [
                /Mag.*Hallowed*Katalox*Staff*of*Destruction/i,
                /Mag.*Hallowed*Oak*Staff*of*Heimdall/i,
